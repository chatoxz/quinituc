...
class PersonaController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-empleado'],
                        'roles' => ['theCreator']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Persona information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Persona model by another data,
